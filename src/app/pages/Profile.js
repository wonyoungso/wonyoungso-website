          ...
          <div className="profile-desc-cv">
            <div className="profile-desc-cv__desc">
              ...
              <p className="profile-paragraph" style={fgStyle}>
                I am a Ph.D. candidate in Urban Science at the Department of Urban Studies and Planning (DUSP) at the Massachusetts Institute of Technology (MIT), where I was a <a href="https://oge.mit.edu/fellowships/presidential-graduate-fellowship-program/" target="_blank">Presidential Fellow</a>. I am also working as a research assistant and technical lead at the <a href="https://dataplusfeminism.mit.edu" target="_blank">Data + Feminism Lab</a> at MIT. In 2011, I co-founded the crowdfunding platform Tumblbug and demonstrated an alternative to the sustainability of the DIY movement. I was a research fellow at the Senseable City Lab at MIT, and I co-curated Seoul Libre Maps at the Seoul Biennale of Architecture and Urbanism to realize the vision of a citizen-organized data community. I hold a Master in City Planning from MIT DUSP, a BFA in Visual Communication Design from Kookmin University, and I studied at the School for Poetic Computation in New York City. My work has been recognized by the Information is Beautiful Awards, Adobe, MIT Museum, the Seoul Biennale of Architecture and Urbanism, IEEE, Fast Co. Design, The Atlantic, CNN, The Guardian, Seoul Museum of Art, and Wired, among others.
              </p>
            </div>
