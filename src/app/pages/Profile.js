          ...
          <div className="profile-desc-cv">
            <div className="profile-desc-cv__desc">
              ...
              <p className="profile-paragraph" style={fgStyle}>
                Welcome! I am a PhD candidate at <a href="https://dusp.mit.edu/people/wonyoung-so" target="_blank" rel="noreferrer" style={{...fgStyle, textDecoration: "underline"}}> the Department of Urban Studies and Planning</a> (DUSP) at the Massachusetts Institute of Technology (MIT). I work at the intersection of urban planning, critical data studies, and data visualization to study how access to resources and opportunities over space and place is mediated by data and technology, with a particular focus on housing. To this end, I combine data-driven methods and data visualization practices to empirically bolster and rhetorically frame narratives for translating scholarly research into public impact. I center issues of justice and equity to promote the democratic participation of marginalized residents—particularly those marginalized by class, race, gender, and disability, among other durable categories of inequality—who are disproportionately excluded from accessing resources and opportunities, especially when such access is governed by algorithms and AI. 
              </p>
